...
import student.Controllers.UserController;
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        ...
        if(username != null && password != null && username.length() != 0 && password.length() != 0) {
            ...
            if( login) {
                ...
                JOptionPane.showMessageDialog(panel, "Username or Password is incorrect", "Error", JOptionPane.ERROR_MESSAGE);
            }
            
        } else {
            JOptionPane.showMessageDialog(panel, "Username or Password cannot be empty", "Error", JOptionPane.ERROR_MESSAGE);
        }
